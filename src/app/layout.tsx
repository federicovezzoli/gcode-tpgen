      ...
      <body className="min-h-full flex flex-col">
        <ThemeProvider>
          ...
          <footer className="border-t mt-12">
            <div className="container mx-auto px-4 py-4 max-w-5xl flex flex-wrap gap-x-4 gap-y-1 text-xs text-muted-foreground items-center">
              <span>
                Made by{' '}
                <a
              ...
              <span>·</span>
              <a
                href="https://github.com/federicovezzoli/gcode-tools"
                target="_blank"
                rel="noopener noreferrer"
